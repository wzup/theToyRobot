 ...
 * to start an app. It gets the robot instance and uses its methods to controll
 * the robot and output messages to user.
 */
 ...
 * or from a file.
 * @param  {String} sCommand a command from a user, lile "PLACE, MOVE, etc."
 * @return {Error|String|Object} returns either an Error instance, or a message
 * string, or robot instance. The return value depends on what the robot
 * returned. A successful action returns robot's instance.
 * @private
 */
...
/**
 * A class TheToyRobotApp
 * It has only one static method .run() to strat the app
 */
